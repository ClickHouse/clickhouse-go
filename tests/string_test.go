...
//func TestNullableStringFromDriverValuerType(t *testing.T) {
//	conn, err := GetConnection("native", nil, nil, &clickhouse.Compression{
//		Method: clickhouse.CompressionLZ4,
//	})
//	ctx := context.Background()
...
//	}
//	const ddl = `
//		CREATE TABLE test_string_nullable (
//			  	  Col1 String
//		        , Col2 Nullable(String)
//		) Engine MergeTree() ORDER BY tuple()
//		`
//	defer func() {
//		conn.Exec(ctx, "DROP TABLE test_string_nullable")
//	}()
//	require.NoError(t, conn.Exec(ctx, ddl))
//	batch, err := conn.PrepareBatch(ctx, "INSERT INTO test_string_nullable")
//	require.NoError(t, err)
//
//	type data struct {
//		Col1 string                `ch:"Col1"`
...
//
//	var dest data
//	require.NoError(t, conn.QueryRow(ctx, "SELECT * FROM test_string_nullable").ScanStruct(&dest))
//	assert.Equal(t, "Value", dest.Col1)
//	assert.Equal(t, testStringSerializer{"Value"}, dest.Col2)
//}
